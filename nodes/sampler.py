...
class ShimaSampler:
    ...
    RETURN_NAMES = ("latent", "image", "s33d")
    FUNCTION = "sample"
    ...
    def sample(
        ...
        **kwargs,
        ...
        if latentmaker and latentmaker.get("latent") is not None:
             latent_image = latentmaker.get("latent")
        ...
        def run_sampler(latent_input, seed, steps, denoise, add_noise):
            if add_noise:
        ...
        samples_1 = run_sampler(latent_samples, final_s33d, steps, denoise, add_noise)
        ...
        return {
            ...
            "result": (out_latent, image, final_s33d)
        }

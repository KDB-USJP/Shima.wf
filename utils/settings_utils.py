...
class ShimaSettings:
    ...
    DEFAULT_PACKS = {
        "Anime": "https://github.com/Aegisflow/Shima-Assets/releases/download/v1.0.0/anime_styles.zip",
        "Animals": "https://github.com/Aegisflow/Shima-Assets/releases/download/v1.0.0/animal_styles.zip",
        "Landscapes": "https://github.com/Aegisflow/Shima-Assets/releases/download/v1.0.0/landscape_styles.zip"
    }
    ...
    def get_excel_palettes(cls):
        """Parse E:\ComfyDev\Shima\assets\data\shima_sheets.xlsx (tab: node-color-themes)."""
        excel_path = Path(r"E:\ComfyDev\Shima\assets\data\shima_sheets.xlsx")
        palettes = {}
